...
const NavBar = () => {
  ...
  return (
    <>
      <div className=" h-16 flex justify-around items-center pl-5   ">
        <div className="mr-2 px-2 w-full max-lg:w-72 font-semibold text-xl  ">
          <NavLink to={"/"}>
            <img src={logo} alt="hubnex-logo"></img>
          </NavLink>
        </div>
        <div className="flex w-full justify-around  max-sm:hidden ">
        ...
        <div className=" flex w-full justify-end mr-20 gap-5">
