  ...
  return (
    <div>
      ...
      <div className=" absolute w-full flex justify-between ">
        <div className=" felx ">
        <img className="i1 ml-4 max-md:hidden absolute left-60" src="1.svg" />
          <img className="i2 ml-5 max-md:hidden absolute top-6" src="2.svg" />

          <img className="i4 max-md:hidden absolute bottom-8 left-36" src="4.svg" />
        </div>
        ...
        <img className="i3 max-md:hidden relative right-80 top-8 " src="3.svg" />
        <img className="i5 max-md:hidden relative right-20" src="5.svg" />
        </div>
             
        </div>

      <h1 className="max-sm:text-lg max-md:text-2xl font-bold pt-20 p-5 text-5xl flex text-center justify-center">
        ...
        <div className="gg"></div>
          ...
          <div>
            <p className=" max-sm:text-sm max-md:text-xl text-3xl max-md:w-80 max-sm:w-64 pb-5  flex justify-center  font-thin  text-center">
              Personalized learning journey with the  help of expert
              mentors
            </p>
          ...
          <div className="max-md:w-auto max-sm:w-[1px] pt-5 ">
            ...
            <img className="h-[350px] w-[600px] max-sm:hidden max-md:h-52 " src={Boyimg}></img>
